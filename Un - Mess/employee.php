<HTML>
	<?php
		if (isset($_POST['submit']))
		{
			...
			$sql = mysql_query("select * from employee where reg_no='$regnum';");
	...
	<div class="container">
		...
		<center>
		  ...
		  <p class="lead" style="font-size: 17px">SIMPLIFYING THE MESS<br>Employee Login</p>
		 </center>
		</div>
		<div class="row">
			<div class="col-md-4">
			...
			<div class="col-md-4">
				...
				<form method="post" onsubmit="msignup.php">
					<label for="inputReg" class="sr-only">Employee ID</label>
